      ...
      >
        <div className="flex flex-col md:flex-row gap-3">
          <TextField
            ...
            className= "rounded-x1 border border-white/20 bg-white/10 px-3 py-2 outline-none"
          />
          <TextField
            label="UF"
            name="uf"
            ...
            className="rounded-x1 border border-white/20 bg-white/10 px-3 py-2 uppercase outline-none"
          />
        </div>
        <TextAreaField
          label="Descrição"
          ...
          className="rounded-x1 border border-white/20 bg-white/10 px-3 py-2 outline-none resize-none"
        />
